...
def setup():
    ...
    null_godaddy_record(godaddy_api_key, godaddy_api_secret, certbot_domain, root_domain)
...
def null_godaddy_record(godaddy_api_key, godaddy_api_secret, certbot_domain, root_domain):
